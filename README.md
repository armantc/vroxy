...
```bash
CGO_ENABLED=0 go build -o vroxy -trimpath -buildvcs=false -ldflags="-s -w -buildid=" -v ./main
```
...
```bash
CGO_ENABLED=0 go build -o vroxy -trimpath -buildvcs=false -gcflags="all=-l=4" -ldflags="-X github.com/xtls/xray-core/core.build=REPLACE -s -w -buildid=" -v ./main
```

Build for amd64:
```bash
CGO_ENABLED=0 GOARCH=amd64 GOOS=linux go build -o vroxy -trimpath -buildvcs=false -ldflags="-X github.com/xtls/xray-core/core.build=REPLACE -s -w -buildid=" -v ./main
```

If you are compiling a 32-bit MIPS/MIPSLE target, use this command instead:

```bash
CGO_ENABLED=0 go build -o vroxy -trimpath -buildvcs=false -gcflags="-l=4" -ldflags="-X github.com/xtls/xray-core/core.build=REPLACE -s -w -buildid=" -v ./main
```
